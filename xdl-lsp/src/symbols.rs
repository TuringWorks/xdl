...
impl SymbolTable {
    ...
    fn initialize_builtins(&mut self) {
        ...
        let math_funcs = vec![
            (
                "SIN",
                "sin(x) - Compute sine of angle x (radians)",
                "DOUBLE",
                "SIN(x)",
            ),
            (
                "COS",
                "cos(x) - Compute cosine of angle x (radians)",
                "DOUBLE",
                "COS(x)",
            ),
            (
                "TAN",
                "tan(x) - Compute tangent of angle x (radians)",
                "DOUBLE",
                "TAN(x)",
            ),
            ...
            (
                "EXP",
                "exp(x) - Compute e^x (exponential)",
                "DOUBLE",
                "EXP(x)",
            ),
            (
                "ALOG",
                "alog(x) - Compute natural logarithm (ln)",
                "DOUBLE",
                "ALOG(x)",
            ),
            (
                "ALOG10",
                "alog10(x) - Compute base-10 logarithm",
                "DOUBLE",
                "ALOG10(x)",
            ),
        ...
        let array_funcs = vec![
            (
                "FINDGEN",
                "findgen(n) - Generate float array [0, 1, ..., n-1]",
                "ARRAY",
                "FINDGEN(n)",
            ),
            (
                "INDGEN",
                "indgen(n) - Generate integer array [0, 1, ..., n-1]",
                "ARRAY",
                "INDGEN(n)",
            ),
            (
                "DINDGEN",
                "dindgen(n) - Generate double array [0, 1, ..., n-1]",
                "ARRAY",
                "DINDGEN(n)",
            ),
            (
                "BINDGEN",
                "bindgen(n) - Generate byte array [0, 1, ..., n-1]",
                "ARRAY",
                "BINDGEN(n)",
            ),
            (
                "FLTARR",
                "fltarr(dims...) - Create float array of zeros",
                "ARRAY",
                "FLTARR(d1, d2, ...)",
            ),
            (
                "DBLARR",
                "dblarr(dims...) - Create double array of zeros",
                "ARRAY",
                "DBLARR(d1, d2, ...)",
            ),
            (
                "INTARR",
                "intarr(dims...) - Create integer array of zeros",
                "ARRAY",
                "INTARR(d1, d2, ...)",
            ),
            (
                "BYTARR",
                "bytarr(dims...) - Create byte array of zeros",
                "ARRAY",
                "BYTARR(d1, d2, ...)",
            ),
            (
                "STRARR",
                "strarr(dims...) - Create string array",
                "ARRAY",
                "STRARR(d1, d2, ...)",
            ),
            (
                "MAKE_ARRAY",
                "make_array(dims...) - Create array with specified type",
                "ARRAY",
                "MAKE_ARRAY(d1, d2, ..., TYPE=type)",
            ),
            (
                "REPLICATE",
                "replicate(value, dims...) - Create array filled with value",
                "ARRAY",
                "REPLICATE(value, d1, d2, ...)",
            ),
            (
                "WHERE",
                "where(condition) - Find indices where condition is true",
                "ARRAY",
                "WHERE(condition, [COUNT=count])",
            ),
            (
                "N_ELEMENTS",
                "n_elements(arr) - Return number of elements",
                "LONG",
                "N_ELEMENTS(arr)",
            ),
            (
                "SIZE",
                "size(arr) - Return array dimensions info",
                "ARRAY",
                "SIZE(arr, [/DIMENSIONS])",
            ),
            (
                "REFORM",
                "reform(arr, dims...) - Reshape array",
                "ARRAY",
                "REFORM(arr, d1, d2, ...)",
            ),
            (
                "TRANSPOSE",
                "transpose(arr) - Transpose 2D array",
                "ARRAY",
                "TRANSPOSE(arr)",
            ),
            (
                "REVERSE",
                "reverse(arr) - Reverse array elements",
                "ARRAY",
                "REVERSE(arr, [dim])",
            ),
            (
                "SHIFT",
                "shift(arr, s) - Circular shift array",
                "ARRAY",
                "SHIFT(arr, s1, s2, ...)",
            ),
            (
                "ROTATE",
                "rotate(arr, dir) - Rotate 2D array",
                "ARRAY",
                "ROTATE(arr, direction)",
            ),
            (
                "SORT",
                "sort(arr) - Return indices that sort array",
                "ARRAY",
                "SORT(arr)",
            ),
            (
                "UNIQ",
                "uniq(arr) - Return indices of unique elements",
                "ARRAY",
                "UNIQ(arr, [/SORT])",
            ),
        ];
        ...
        let stat_funcs = vec![
            ...
            (
                ...
                "DOUBLE",
                "MIN(arr, [MIN_SUBSCRIPT=idx])",
            ),
            (
                "MAX",
                "max(arr) - Find maximum value",
                "DOUBLE",
                "MAX(arr, [MAX_SUBSCRIPT=idx])",
            ),
            (
                "MOMENT",
                "moment(arr) - Calculate statistical moments",
                "ARRAY",
                "MOMENT(arr)",
            ),
            (
                "CORRELATE",
                "correlate(x, y) - Compute correlation",
                "DOUBLE",
                "CORRELATE(x, y)",
            ),
            (
                "HISTOGRAM",
                "histogram(arr) - Compute histogram",
                "ARRAY",
                "HISTOGRAM(arr, [BINSIZE=bs])",
            ),
        ];
        ...
        let string_funcs = vec![
            ...
            (
                "STRMID",
                "strmid(str, start, len) - Extract substring",
                "STRING",
                "STRMID(str, start, [len])",
            ),
            (
                "STRPOS",
                "strpos(str, search) - Find substring position",
                "LONG",
                "STRPOS(str, search, [start])",
            ),
            (
                "STRTRIM",
                "strtrim(str, flag) - Trim whitespace",
                "STRING",
                "STRTRIM(str, [flag])",
            ),
            (
                "STRUPCASE",
                "strupcase(str) - Convert to uppercase",
                "STRING",
                "STRUPCASE(str)",
            ),
            (
                "STRLOWCASE",
                "strlowcase(str) - Convert to lowercase",
                "STRING",
                "STRLOWCASE(str)",
            ),
            (
                ...
                "STRING",
                "STRING(value, [FORMAT=fmt])",
            ),
            (
                "STRSPLIT",
                "strsplit(str, pattern) - Split string",
                "ARRAY",
                "STRSPLIT(str, pattern, [/EXTRACT])",
            ),
            (
                "STRJOIN",
                "strjoin(arr, delim) - Join strings",
                "STRING",
        ...
        let io_funcs = vec![
            (
                "READ_ASCII",
                "read_ascii(file) - Read ASCII data file",
                "STRUCT",
                "READ_ASCII(file)",
            ),
            (
            ...
            (
                "READ_BINARY",
                "read_binary(file) - Read binary file",
                "ARRAY",
                "READ_BINARY(file)",
            ),
            (
                "READF",
                "readf(unit, vars...) - Formatted read",
                "VOID",
                "READF, unit, var1, var2, ...",
            ),
            (
                "READU",
                "readu(unit, vars...) - Unformatted read",
                "VOID",
                "READU, unit, var1, var2, ...",
            ),
            (
                "FILE_TEST",
                "file_test(path) - Test if file exists",
                "LONG",
                "FILE_TEST(path)",
            ),
            (
            ...
            (
                "FILE_SEARCH",
                "file_search(pattern) - Search for files",
                "ARRAY",
                "FILE_SEARCH(pattern)",
            ),
            (
                "FILE_LINES",
                "file_lines(file) - Count lines in file",
                "LONG",
                "FILE_LINES(file)",
            ),
        ];
        ...
        let procedures = vec![
            ...
            (
                "PRINTF",
                "printf, unit, args... - Formatted print to file",
                "PRINTF, unit, format, expr1, ...",
            ),
            (
                "WRITEF",
                "writef, unit, args... - Formatted write to file",
                "WRITEF, unit, format, expr1, ...",
            ),
            (
                "WRITEU",
                "writeu, unit, args... - Unformatted write to file",
                "WRITEU, unit, expr1, ...",
            ),
            (
                "OPENR",
                "openr, unit, file - Open file for reading",
                "OPENR, unit, filename",
            ),
            (
                "OPENW",
                "openw, unit, file - Open file for writing",
                "OPENW, unit, filename",
            ),
            (
                "OPENU",
                "openu, unit, file - Open file for update",
                "OPENU, unit, filename",
            ),
            ...
            (
                "PLOT",
                "plot, x, y - Create 2D line plot",
                "PLOT, [x,] y, [keywords]",
            ),
            (
                "OPLOT",
                "oplot, x, y - Overplot on existing plot",
                "OPLOT, [x,] y, [keywords]",
            ),
            (
                "CONTOUR",
                "contour, z, x, y - Create contour plot",
                "CONTOUR, z, [x, y], [keywords]",
            ),
            (
                "SURFACE",
                "surface, z - Create 3D surface plot",
                "SURFACE, z, [x, y], [keywords]",
            ),
            (
                "SHADE_SURF",
                "shade_surf, z - Create shaded surface",
                "SHADE_SURF, z, [x, y], [keywords]",
            ),
            ("TV", "tv, image - Display image", "TV, image, [x, y]"),
            (
                "TVSCL",
                "tvscl, image - Display scaled image",
                "TVSCL, image, [x, y]",
            ),
            (
                "WINDOW",
                "window, id - Create graphics window",
                "WINDOW, [window_id], [keywords]",
            ),
            ("WSET", "wset, id - Set current window", "WSET, window_id"),
            (
                "WDELETE",
                "wdelete, id - Delete window",
                "WDELETE, [window_id]",
            ),
            (
                "DEVICE",
                "device, keywords - Control graphics device",
                "DEVICE, [keywords]",
            ),
            ("ERASE", "erase - Clear graphics window", "ERASE, [color]"),
            (
                "HELP",
                "help, var - Display variable information",
                "HELP, [variable]",
            ),
            ...
            (
                "ON_ERROR",
                "on_error, action - Set error handling",
                "ON_ERROR, action",
            ),
            (
                "CATCH",
                "catch, variable - Catch errors",
                "CATCH, error_status",
            ),
            (
                "PTR_NEW",
                "ptr_new(value) - Create new pointer",
                "PTR_NEW([value])",
            ),
            ("PTR_FREE", "ptr_free, ptr - Free pointer", "PTR_FREE, ptr"),
            (
                "OBJ_NEW",
                "obj_new(class) - Create new object",
                "OBJ_NEW(class, [args])",
            ),
            (
                "OBJ_DESTROY",
                "obj_destroy, obj - Destroy object",
                "OBJ_DESTROY, obj",
            ),
        ];
        ...
        let sys_vars = vec![
            ...
            (
                "VALUES",
                "Special floating point values structure",
                "STRUCT",
            ),
